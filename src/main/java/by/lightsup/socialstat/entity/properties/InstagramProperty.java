...
public class InstagramProperty {
    ...
    private static ResourceBundle getBundle() {
        ...
        try {
            ...
            String message =
                    "Exception occurred while getting ResourceBundle for property with basename: " + PROPERTY_FILE_NAME;
            LOG.error(message, e);
        }
        return bundle;
    }
    ...
    public String constructAuthorizeURL() {
        return this.authorizeURL + format(UrlUtil.AUTHORIZE_PARAMETERS_TEMPLATE, this.clientId, this.redirectURI, this.responseType);
    }

    public String constructTokenParameters(String responseCode) {
        String code = this.responseType + "=" + responseCode;
        return format(TOKEN_PARAMETERS_TEMPLATE, this.clientId, this.clientSecret, this.grantType, this.redirectURI, code);
    }
